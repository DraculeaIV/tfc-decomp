...
/* 1060 */     int i = 0;
/*      */     
/* 1062 */     bismuthSheet = (Item)((ItemMetalSheet)(new ItemMetalSheet(0)).func_77655_b("Bismuth Sheet")).setMetal("Bismuth", 200);
/* 1063 */     bismuthBronzeSheet = (Item)((ItemMetalSheet)(new ItemMetalSheet(1)).func_77655_b("Bismuth Bronze Sheet")).setMetal("Bismuth Bronze", 200);
/* 1064 */     blackBronzeSheet = (Item)((ItemMetalSheet)(new ItemMetalSheet(2)).func_77655_b("Black Bronze Sheet")).setMetal("Black Bronze", 200);
/* 1065 */     blackSteelSheet = (Item)((ItemMetalSheet)(new ItemMetalSheet(3)).func_77655_b("Black Steel Sheet")).setMetal("Black Steel", 200);
/* 1066 */     blueSteelSheet = (Item)((ItemMetalSheet)(new ItemMetalSheet(4)).func_77655_b("Blue Steel Sheet")).setMetal("Blue Steel", 200);
/* 1067 */     bronzeSheet = (Item)((ItemMetalSheet)(new ItemMetalSheet(6)).func_77655_b("Bronze Sheet")).setMetal("Bronze", 200);
/* 1068 */     copperSheet = (Item)((ItemMetalSheet)(new ItemMetalSheet(7)).func_77655_b("Copper Sheet")).setMetal("Copper", 200);
/* 1069 */     wroughtIronSheet = (Item)((ItemMetalSheet)(new ItemMetalSheet(9)).func_77655_b("Wrought Iron Sheet")).setMetal("Wrought Iron", 200);
/* 1070 */     redSteelSheet = (Item)((ItemMetalSheet)(new ItemMetalSheet(14)).func_77655_b("Red Steel Sheet")).setMetal("Red Steel", 200);
/* 1071 */     roseGoldSheet = (Item)((ItemMetalSheet)(new ItemMetalSheet(15)).func_77655_b("Rose Gold Sheet")).setMetal("Rose Gold", 200);
/* 1072 */     steelSheet = (Item)((ItemMetalSheet)(new ItemMetalSheet(17)).func_77655_b("Steel Sheet")).setMetal("Steel", 200);
/* 1073 */     tinSheet = (Item)((ItemMetalSheet)(new ItemMetalSheet(19)).func_77655_b("Tin Sheet")).setMetal("Tin", 200);
/* 1074 */     zincSheet = (Item)((ItemMetalSheet)(new ItemMetalSheet(20)).func_77655_b("Zinc Sheet")).setMetal("Zinc", 200);
/* 1075 */     electrumSheet = (Item)((ItemMetalSheet)(new ItemMetalSheet(21)).func_77655_b("Electrum Sheet")).setMetal("Electrum", 200);
/* 1076 */     cupronickelSheet = (Item)((ItemMetalSheet)(new ItemMetalSheet(22)).func_77655_b("Cupronickel Sheet")).setMetal("Cupronickel", 200);
/*      */     
/* 1078 */     bismuthSheet2x = (Item)((ItemMetalSheet2x)(new ItemMetalSheet2x(0)).func_77655_b("Bismuth Double Sheet")).setMetal("Bismuth", 400);
/* 1079 */     bismuthBronzeSheet2x = (Item)((ItemMetalSheet2x)(new ItemMetalSheet2x(1)).func_77655_b("Bismuth Bronze Double Sheet")).setMetal("Bismuth Bronze", 400);
/* 1080 */     blackBronzeSheet2x = (Item)((ItemMetalSheet2x)(new ItemMetalSheet2x(2)).func_77655_b("Black Bronze Double Sheet")).setMetal("Black Bronze", 400);
/* 1081 */     blackSteelSheet2x = (Item)((ItemMetalSheet2x)(new ItemMetalSheet2x(3)).func_77655_b("Black Steel Double Sheet")).setMetal("Black Steel", 400);
/* 1082 */     blueSteelSheet2x = (Item)((ItemMetalSheet2x)(new ItemMetalSheet2x(4)).func_77655_b("Blue Steel Double Sheet")).setMetal("Blue Steel", 400);
/* 1083 */     bronzeSheet2x = (Item)((ItemMetalSheet2x)(new ItemMetalSheet2x(6)).func_77655_b("Bronze Double Sheet")).setMetal("Bronze", 400);
/* 1084 */     copperSheet2x = (Item)((ItemMetalSheet2x)(new ItemMetalSheet2x(7)).func_77655_b("Copper Double Sheet")).setMetal("Copper", 400);
/* 1085 */     wroughtIronSheet2x = (Item)((ItemMetalSheet2x)(new ItemMetalSheet2x(9)).func_77655_b("Wrought Iron Double Sheet")).setMetal("Wrought Iron", 400);
/* 1086 */     redSteelSheet2x = (Item)((ItemMetalSheet2x)(new ItemMetalSheet2x(14)).func_77655_b("Red Steel Double Sheet")).setMetal("Red Steel", 400);
/* 1087 */     roseGoldSheet2x = (Item)((ItemMetalSheet2x)(new ItemMetalSheet2x(15)).func_77655_b("Rose Gold Double Sheet")).setMetal("Rose Gold", 400);
/* 1088 */     steelSheet2x = (Item)((ItemMetalSheet2x)(new ItemMetalSheet2x(17)).func_77655_b("Steel Double Sheet")).setMetal("Steel", 400);
/* 1089 */     tinSheet2x = (Item)((ItemMetalSheet2x)(new ItemMetalSheet2x(19)).func_77655_b("Tin Double Sheet")).setMetal("Tin", 400);
/* 1090 */     zincSheet2x = (Item)((ItemMetalSheet2x)(new ItemMetalSheet2x(20)).func_77655_b("Zinc Double Sheet")).setMetal("Zinc", 400);
/* 1091 */     electrumSheet2x = (Item)((ItemMetalSheet2x)(new ItemMetalSheet2x(21)).func_77655_b("Electrum Double Sheet")).setMetal("Electrum", 400);
/* 1092 */     cupronickelSheet2x = (Item)((ItemMetalSheet2x)(new ItemMetalSheet2x(22)).func_77655_b("Cupronickel Double Sheet")).setMetal("Cupronickel", 400);
/*      */     
/* 1094 */     i = 0;
/* 1095 */     brassSheet = (new ItemMetalSheet(5)).setMetal("Brass", 200).func_77655_b(namesNSO[i++] + " Sheet");
/* 1096 */     goldSheet = (new ItemMetalSheet(8)).setMetal("Gold", 200).func_77655_b(namesNSO[i++] + " Sheet");
/* 1097 */     leadSheet = (new ItemMetalSheet(10)).setMetal("Lead", 200).func_77655_b(namesNSO[i++] + " Sheet");
/* 1098 */     nickelSheet = (new ItemMetalSheet(11)).setMetal("Nickel", 200).func_77655_b(namesNSO[i++] + " Sheet");
/* 1099 */     pigIronSheet = (new ItemMetalSheet(12)).setMetal("Pig Iron", 200).func_77655_b(namesNSO[i++] + " Sheet");
/* 1100 */     platinumSheet = (new ItemMetalSheet(13)).setMetal("Platinum", 200).func_77655_b(namesNSO[i++] + " Sheet");
/* 1101 */     silverSheet = (new ItemMetalSheet(16)).setMetal("Silver", 200).func_77655_b(namesNSO[i++] + " Sheet");
/* 1102 */     sterlingSilverSheet = (new ItemMetalSheet(18)).setMetal("Sterling Silver", 200).func_77655_b(namesNSO[i++] + " Sheet");
/*      */     
/* 1104 */     i = 0;
/* 1105 */     brassSheet2x = (new ItemMetalSheet2x(5)).setMetal("Brass", 400).func_77655_b(namesNSO[i++] + " Double Sheet");
/* 1106 */     goldSheet2x = (new ItemMetalSheet2x(8)).setMetal("Gold", 400).func_77655_b(namesNSO[i++] + " Double Sheet");
/* 1107 */     leadSheet2x = (new ItemMetalSheet2x(10)).setMetal("Lead", 400).func_77655_b(namesNSO[i++] + " Double Sheet");
/* 1108 */     nickelSheet2x = (new ItemMetalSheet2x(1)).setMetal("Nickel", 400).func_77655_b(namesNSO[i++] + " Double Sheet");
/* 1109 */     pigIronSheet2x = (new ItemMetalSheet2x(12)).setMetal("Pig Iron", 400).func_77655_b(namesNSO[i++] + " Double Sheet");
/* 1110 */     platinumSheet2x = (new ItemMetalSheet2x(13)).setMetal("Platinum", 400).func_77655_b(namesNSO[i++] + " Double Sheet");
/* 1111 */     silverSheet2x = (new ItemMetalSheet2x(16)).setMetal("Silver", 400).func_77655_b(namesNSO[i++] + " Double Sheet");
/* 1112 */     sterlingSilverSheet2x = (new ItemMetalSheet2x(18)).setMetal("Sterling Silver", 400).func_77655_b(namesNSO[i++] + " Double Sheet");
/*      */     
/* 1114 */     i = 0;
