...
/* 124 */     EntityRegistry.registerGlobalEntityID(EntityPigTFC.class, "pigTFC", EntityRegistry.findGlobalUniqueEntityId(), 15173510, 2490406);
...
/*     */     
/* 140 */     EntityRegistry.registerGlobalEntityID(EntitySheepTFC.class, "sheepTFC", EntityRegistry.findGlobalUniqueEntityId(), 13483956, 2490406);
...
/* 154 */     EntityRegistry.registerModEntity(EntityCowTFC.class, "cowTFC", 6, TerraFirmaCraft.instance, 160, 5, true);
...
/* 158 */     EntityRegistry.registerModEntity(EntityPigTFC.class, "pigTFC", 10, TerraFirmaCraft.instance, 160, 5, true);
...
/* 211 */     FluidRegistry.registerFluid(TFCFluids.MILKCURDLED);
...
/* 218 */     FluidContainerRegistry.registerFluidContainer(FluidRegistry.getFluid(TFCFluids.LAVA.getName()), new ItemStack(TFCItems.blueSteelBucketLava), new ItemStack(TFCItems.blueSteelBucketEmpty));
/* 219 */     FluidContainerRegistry.registerFluidContainer(FluidRegistry.getFluid(TFCFluids.FRESHWATER.getName()), new ItemStack(TFCItems.redSteelBucketWater), new ItemStack(TFCItems.redSteelBucketEmpty));
/* 220 */     FluidContainerRegistry.registerFluidContainer(FluidRegistry.getFluid(TFCFluids.SALTWATER.getName()), new ItemStack(TFCItems.redSteelBucketSaltWater), new ItemStack(TFCItems.redSteelBucketEmpty));
/* 221 */     FluidContainerRegistry.registerFluidContainer(FluidRegistry.getFluid(TFCFluids.FRESHWATER.getName()), new ItemStack(TFCItems.woodenBucketWater), new ItemStack(TFCItems.woodenBucketEmpty));
/* 222 */     FluidContainerRegistry.registerFluidContainer(FluidRegistry.getFluid(TFCFluids.SALTWATER.getName()), new ItemStack(TFCItems.woodenBucketSaltWater), new ItemStack(TFCItems.woodenBucketEmpty));
/* 223 */     FluidContainerRegistry.registerFluidContainer(new FluidStack(TFCFluids.FRESHWATER, 1000), new ItemStack(TFCItems.potteryJug, 1, 2), new ItemStack(TFCItems.potteryJug, 1, 1));
/* 224 */     FluidContainerRegistry.registerFluidContainer(new FluidStack(TFCFluids.RUM, 250), new ItemStack(TFCItems.rum), new ItemStack(TFCItems.glassBottle));
/* 225 */     FluidContainerRegistry.registerFluidContainer(new FluidStack(TFCFluids.BEER, 250), new ItemStack(TFCItems.beer), new ItemStack(TFCItems.glassBottle));
/* 226 */     FluidContainerRegistry.registerFluidContainer(new FluidStack(TFCFluids.RYEWHISKEY, 250), new ItemStack(TFCItems.ryeWhiskey), new ItemStack(TFCItems.glassBottle));
/* 227 */     FluidContainerRegistry.registerFluidContainer(new FluidStack(TFCFluids.WHISKEY, 250), new ItemStack(TFCItems.whiskey), new ItemStack(TFCItems.glassBottle));
/* 228 */     FluidContainerRegistry.registerFluidContainer(new FluidStack(TFCFluids.CORNWHISKEY, 250), new ItemStack(TFCItems.cornWhiskey), new ItemStack(TFCItems.glassBottle));
/* 229 */     FluidContainerRegistry.registerFluidContainer(new FluidStack(TFCFluids.SAKE, 250), new ItemStack(TFCItems.sake), new ItemStack(TFCItems.glassBottle));
/* 230 */     FluidContainerRegistry.registerFluidContainer(new FluidStack(TFCFluids.CIDER, 250), new ItemStack(TFCItems.cider), new ItemStack(TFCItems.glassBottle));
/* 231 */     FluidContainerRegistry.registerFluidContainer(new FluidStack(TFCFluids.VODKA, 250), new ItemStack(TFCItems.vodka), new ItemStack(TFCItems.glassBottle));
/* 232 */     FluidContainerRegistry.registerFluidContainer(new FluidStack(TFCFluids.MILK, 1000), new ItemStack(TFCItems.woodenBucketMilk), new ItemStack(TFCItems.woodenBucketEmpty));
/* 233 */     FluidContainerRegistry.registerFluidContainer(new FluidStack(TFCFluids.VINEGAR, 1000), new ItemStack(TFCItems.vinegar), new ItemStack(TFCItems.woodenBucketEmpty));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 246 */     TFCItems.bismuthBronzePick.setHarvestLevel("pickaxe", 2);
/* 247 */     TFCItems.bismuthBronzePick.setHarvestLevel("pickaxe", 2);
/* 248 */     TFCItems.blackBronzePick.setHarvestLevel("pickaxe", 2);
/* 249 */     TFCItems.blackSteelPick.setHarvestLevel("pickaxe", 5);
/* 250 */     TFCItems.blueSteelPick.setHarvestLevel("pickaxe", 6);
/* 251 */     TFCItems.bronzePick.setHarvestLevel("pickaxe", 2);
/* 252 */     TFCItems.copperPick.setHarvestLevel("pickaxe", 1);
/* 253 */     TFCItems.wroughtIronPick.setHarvestLevel("pickaxe", 3);
/* 254 */     TFCItems.redSteelPick.setHarvestLevel("pickaxe", 6);
/* 255 */     TFCItems.steelPick.setHarvestLevel("pickaxe", 4);
/*     */     
/* 257 */     TFCItems.igInShovel.setHarvestLevel("shovel", 1);
/* 258 */     TFCItems.igExShovel.setHarvestLevel("shovel", 1);
/* 259 */     TFCItems.sedShovel.setHarvestLevel("shovel", 1);
/* 260 */     TFCItems.mMShovel.setHarvestLevel("shovel", 1);
/* 261 */     TFCItems.bismuthBronzeShovel.setHarvestLevel("shovel", 2);
/* 262 */     TFCItems.blackBronzeShovel.setHarvestLevel("shovel", 2);
/* 263 */     TFCItems.blackSteelShovel.setHarvestLevel("shovel", 5);
/* 264 */     TFCItems.blueSteelShovel.setHarvestLevel("shovel", 6);
/* 265 */     TFCItems.bronzeShovel.setHarvestLevel("shovel", 2);
/* 266 */     TFCItems.copperShovel.setHarvestLevel("shovel", 1);
/* 267 */     TFCItems.wroughtIronShovel.setHarvestLevel("shovel", 3);
/* 268 */     TFCItems.redSteelShovel.setHarvestLevel("shovel", 6);
/* 269 */     TFCItems.steelShovel.setHarvestLevel("shovel", 4);
/*     */     
/* 271 */     TFCItems.igInAxe.setHarvestLevel("axe", 1);
/* 272 */     TFCItems.igExAxe.setHarvestLevel("axe", 1);
/* 273 */     TFCItems.sedAxe.setHarvestLevel("axe", 1);
/* 274 */     TFCItems.mMAxe.setHarvestLevel("axe", 1);
/* 275 */     TFCItems.bismuthBronzeAxe.setHarvestLevel("axe", 2);
/* 276 */     TFCItems.blackBronzeAxe.setHarvestLevel("axe", 2);
/* 277 */     TFCItems.blackSteelAxe.setHarvestLevel("axe", 5);
/* 278 */     TFCItems.blueSteelAxe.setHarvestLevel("axe", 6);
/* 279 */     TFCItems.bronzeAxe.setHarvestLevel("axe", 2);
/* 280 */     TFCItems.copperAxe.setHarvestLevel("axe", 1);
/* 281 */     TFCItems.wroughtIronAxe.setHarvestLevel("axe", 3);
/* 282 */     TFCItems.redSteelAxe.setHarvestLevel("axe", 6);
/* 283 */     TFCItems.steelAxe.setHarvestLevel("axe", 4);
/*     */     
/* 285 */     TFCItems.bismuthBronzeSaw.setHarvestLevel("axe", 2);
/* 286 */     TFCItems.blackBronzeSaw.setHarvestLevel("axe", 2);
/* 287 */     TFCItems.blackSteelSaw.setHarvestLevel("axe", 5);
/* 288 */     TFCItems.blueSteelSaw.setHarvestLevel("axe", 6);
/* 289 */     TFCItems.bronzeSaw.setHarvestLevel("axe", 2);
/* 290 */     TFCItems.copperSaw.setHarvestLevel("axe", 1);
/* 291 */     TFCItems.wroughtIronSaw.setHarvestLevel("axe", 3);
/* 292 */     TFCItems.redSteelSaw.setHarvestLevel("axe", 6);
/* 293 */     TFCItems.steelSaw.setHarvestLevel("axe", 4);
/*     */     
/* 295 */     TFCItems.stoneHammer.setHarvestLevel("hammer", 1);
/* 296 */     TFCItems.bismuthBronzeHammer.setHarvestLevel("hammer", 2);
/* 297 */     TFCItems.blackBronzeHammer.setHarvestLevel("hammer", 2);
/* 298 */     TFCItems.blackSteelHammer.setHarvestLevel("hammer", 5);
/* 299 */     TFCItems.blueSteelHammer.setHarvestLevel("hammer", 6);
/* 300 */     TFCItems.bronzeHammer.setHarvestLevel("hammer", 2);
/* 301 */     TFCItems.copperHammer.setHarvestLevel("hammer", 1);
/* 302 */     TFCItems.wroughtIronHammer.setHarvestLevel("hammer", 3);
/* 303 */     TFCItems.redSteelHammer.setHarvestLevel("hammer", 6);
/* 304 */     TFCItems.steelHammer.setHarvestLevel("hammer", 4);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 322 */     return MinecraftServer.func_71276_C().func_130014_f_();
/*     */   }
/*     */ 
/*     */   
...
/* 342 */     FMLCommonHandler.instance().firePlayerCraftingEvent(entityplayer, itemstack, iinventory);
/*     */   }
/*     */ 
/*     */   
...
/* 377 */     FMLCommonHandler.instance().bus().register(new ServerTickHandler());
/*     */   }
/*     */ 
/*     */   
/*     */   public void registerGuiHandler() {
/* 382 */     NetworkRegistry.INSTANCE.registerGuiHandler(TerraFirmaCraft.instance, (IGuiHandler)new GuiHandler());
/*     */   }
/*     */ 
/*     */   
/*     */   public void registerWailaClasses() {
/* 387 */     FMLInterModComms.sendMessage("Waila", "register", "com.bioxx.tfc.WAILA.WAILAData.callbackRegister");
/* 388 */     FMLInterModComms.sendMessage("Waila", "register", "com.bioxx.tfc.WAILA.WMobs.callbackRegister");
/* 389 */     FMLInterModComms.sendMessage("Waila", "register", "com.bioxx.tfc.WAILA.WCrucible.callbackRegister");
/*     */   }
/*     */ 
/*     */   
/*     */   public void registerChiselModes() {
/* 394 */     ChiselManager.getInstance().addChiselMode((ChiselMode)new ChiselMode_Smooth("Smooth"));
/* 395 */     ChiselManager.getInstance().addChiselMode((ChiselMode)new ChiselMode_Stair("Stairs"));
/* 396 */     ChiselManager.getInstance().addChiselMode((ChiselMode)new ChiselMode_Slab("Slabs"));
/* 397 */     ChiselManager.getInstance().addChiselMode((ChiselMode)new ChiselMode_Detailed("Detailed"));
/*     */   }
/*     */   
