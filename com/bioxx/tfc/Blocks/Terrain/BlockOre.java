...
/*     */       
/* 272 */       TileEntity te = world.func_147438_o(x, y, z);
/* 273 */       if (!(te instanceof TEOre)) {
/*     */         
/* 275 */         TerraFirmaCraft.LOG.warn("TE was not ore on call of BlockOre.scanVisible({}, {}, {}, {})", new Object[] { world, Integer.valueOf(x), Integer.valueOf(y), Integer.valueOf(z) });
/*     */         
/*     */         return;
/*     */       } 
/* 279 */       if ((((TEOre)te).extraData & 0x8) == 0 && y < 255 && y > 0)
/*     */       {
/* 281 */         if (world.func_72899_e(x, y - 1, z) && world.func_72899_e(x, y + 1, z) && world.func_72899_e(x - 1, y, z) && world.func_72899_e(x + 1, y, z) && world
/* 282 */           .func_72899_e(x, y, z - 1) && world.func_72899_e(x, y, z + 1) && (
/* 283 */           !world.func_147439_a(x, y - 1, z).func_149662_c() || !world.func_147439_a(x, y + 1, z).func_149662_c() || 
/* 284 */           !world.func_147439_a(x - 1, y, z).func_149662_c() || !world.func_147439_a(x + 1, y, z).func_149662_c() || 
/* 285 */           !world.func_147439_a(x, y, z - 1).func_149662_c() || !world.func_147439_a(x, y, z + 1).func_149662_c()))
/*     */         {
/* 287 */           ((TEOre)te).setVisible();
/*     */         }
/*     */       }
/*     */     } 
/*     */   }
...
/*     */     {
/* 298 */       scanVisible(world, x, y, z);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Documents\Tencent Files\1347803543\FileRecv\Moegcraft3.3.2.0-Pre1更新包,请删除原先所有文件夹后拖入\mods\[1.7.10]TerraFirmaCraft-0.79.36-TFR-v2.jar!\com\bioxx\tfc\Blocks\Terrain\BlockOre.class
